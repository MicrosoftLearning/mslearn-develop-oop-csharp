...
1. Download the starter code from the following URL: [Implement interfaces - exercise code projects](https://github.com/MicrosoftLearning/mslearn-develop-oop-csharp/blob/main/DownloadableCodeProjects/Downloads/LP3SampleApps.zip)
